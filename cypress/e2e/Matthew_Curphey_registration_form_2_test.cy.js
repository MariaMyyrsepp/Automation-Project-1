...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', ()=>{
        ...
        cy.get('[data-testid="phoneNumberTestId"]').type(123466)
        cy.get("#email").type("randomEmail")
        
         // Type confirmation password which is the same as the  first password
    ...
    it('User can submit form with all fields added', ()=>{
        ...
        cy.get('#username').type('Matthew')
        cy.get("[data-cy=name]").type('Matt')
        cy.get('input[name="lastName"]').type('Curphey')
        cy.get('[data-testid="phoneNumberTestId"]').type(123466)
        ...
        cy.get("input[name='password']").type('oruveski123')
        cy.get('[name="confirm"]').type('oruveski123')
    ...
    it('User can submit form with valid data and only mandatory fields added', ()=>{
        ...
        cy.get('[name="confirm"]').type('oruveskitalu123').clear('')
        // Assert that submit button is enabled
        cy.get('h2').contains('Password').click()
